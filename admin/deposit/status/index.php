                  ...
                  <div class="card-body">
                    ...
                    <?php if (!empty($deposit)) { ?>
                      <div class="rounded p-3 mb-3">
                        ...
                        <!-- Deposit Info -->
                        <h6 class="fw-bold mb-1">User: <?php echo $deposit['fullname']; ?>
                          <span class="text-muted">(<?php echo $deposit['email']; ?>)</span>
                        </h6>
                        <div style="flex-direction: column; gap:10px" class="mt-2 d-flex flex-col g-3 p-2 border rounded bg-light">
                          ...
                          if ($deposit['type'] == 'crypto') { ?>
                            <div><strong>Wallet Name:</strong> <?php echo $deposit['wallet_name']; ?></div>
                            <div><strong>Wallet Network:</strong> <?php echo $deposit['wallet_network']; ?>
                            </div>
                            <div><strong>Wallet Address:</strong> <?php echo $deposit['wallet_address']; ?></div>
                          <?php } else { ?>

                            <div><strong>Bank Name:</strong> <?php echo $deposit['bank_name']; ?></div>
                            <div><strong>Account Name:</strong> <?php echo $deposit['account_name']; ?></div>
                            <div><strong>Account Number:</strong> <?php echo ucfirst($deposit['account_number']); ?> </div>
                    ...
                    <?php } else { ?>
                      <p class="text-muted">Deposit not found.</p>
                    <?php } ?>
