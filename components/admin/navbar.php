     ...
     <ul class="header-content-right"> <!-- Start::header-element -->
       ...
       <li class="header-element"> <!-- Start::header-link|dropdown-toggle --> <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
           <div class="d-flex align-items-center">
             ...
             <div class="d-xl-block d-none lh-1"> <span class="fw-medium lh-1">Mr. Admin</span> </div>
           </div>
         </a> <!-- End::header-link|dropdown-toggle -->
         <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
           <li><a class="dropdown-item d-flex align-items-center" href="<?php echo $domain ?>admin/dashboard"><i class="bi bi-person fs-18 me-2 op-7"></i>dashboard</a></li>
           <li><a class="dropdown-item d-flex align-items-center" href="<?php echo $domain ?>admin/users"><i class="bi bi-check-square fs-16 me-2 op-7"></i>All Users</a></li>
           ...
           <li><a class="dropdown-item d-flex align-items-center" href="<?php echo $domain ?>admin/signout"><i class="bi bi-box-arrow-right fs-18 me-2 op-7"></i>Log Out</a></li>
         </ul>
