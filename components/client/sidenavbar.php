                  ...
                  <div class="main-customer-sidebar"> <!-- Start::nav -->
                    <nav class="main-customer-menu-container nav nav-pills flex-column sub-open active">
                      <ul class="main-customer-menu active">
                        ...
                        <li class="slide"> <a href="<?php echo $domain ?>user/settings" class="side-menu__item"> <i class="bi bi-gear side-menu__icon"></i> <span class="side-menu__label">Settings</span> </a> </li> <!-- End::slide --> <!-- Start::slide -->
                        ...
                        <li class="slide"> <a href="<?php echo $domain ?>user/signout" class="side-menu__item"> <i class="bi bi-box-arrow-right side-menu__icon"></i> <span class="side-menu__label">Sign out</span> </a> </li> <!-- End::slide -->
                      </ul>
                    </nav> <!-- End::nav -->
